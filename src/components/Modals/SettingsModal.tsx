  ...
  return (
    <div className="text-white z-40">
      <div
        aria-modal="true"
        role="dialog"
        className="fixed inset-0 overlfow-y-auto z-modal"
      >
                ...
                <div className="w-[170px]">
                  <div className="relative">
                    <button
                      ...
                      className="flex cursor-pointer items-center rounded px-3 py-1.5 text-left focus:outline-none whitespace-nowrap bg bg-dark-fill-2 active:bg-dark-fill-3 w-full justify-between"
                      type="button"
                    >
                      {fontSize}
                      <BsChevronDown />
                    ...
                    {settings.dropdownIsOpen && (
                      <ul
                        ...
                        style={{
                          filter: "drop-shadow(rgba(0,0,0,0.12) 0px 6px 16px)",
                        }}
                      >
